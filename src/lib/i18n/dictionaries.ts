  ...
  board: {
    analysis: {
      ...
      attach: {
        upload: "上传文件",
        link: "贴链接",
        linkPlaceholder: "粘贴网页链接(http/https)……",
        linkConfirm: "添加",
        linkCancel: "取消",
        parsing: "解析中……",
        failed: "解析失败",
        ...
        charsUnit: "字",
        truncated: "已截取",
        hint: "可附 PDF、Word、图片或网页链接(图片会被 AI 读成文字)",
        limitReached: "最多 5 个附件",
        parsingHint: "附件解析中,请稍候……",
      },
      // 分析中态
      analyzing: {
        title: "正在分析",
  ...
  board: {
    analysis: {
      ...
      attach: {
        upload: "Upload",
        link: "Add link",
        linkPlaceholder: "Paste a web link (http/https)…",
        linkConfirm: "Add",
        linkCancel: "Cancel",
        parsing: "Parsing…",
        failed: "Parse failed",
        ...
        charsUnit: " chars",
        truncated: "truncated",
        hint: "Attach PDF, Word, images, or web links (images are read into text by AI)",
        limitReached: "Up to 5 attachments",
        parsingHint: "Attachments are still parsing, please wait…",
      },
      analyzing: {
        title: "Analyzing",
